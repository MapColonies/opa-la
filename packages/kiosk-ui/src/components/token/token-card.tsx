      ...
      <CardContent className="p-6">
        <div className="min-h-[420px] flex flex-col">
          ...
          <div className="text-center mb-6">
            <h2 className="text-xl font-semibold text-foreground mb-2">Token Generation</h2>
          </div>
          ...
          <div className="flex-1 flex flex-col justify-center">
            {(!tokenData || isLoading) && !isError && (
              <div className="flex flex-col items-center gap-4">
                ...
                {!isLoading && <p className="text-xs text-muted-foreground text-center">Click to generate a new authentication token</p>}
              </div>
            )}
            ...
            {isError && (
              <Alert variant="destructive" className="border-red-200 bg-red-50 dark:bg-red-950/20">
                <AlertTitle className="text-red-800 dark:text-red-200">Generation Failed</AlertTitle>
